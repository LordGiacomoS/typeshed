...
if sys.version_info >= (3, 14):
    ...
    class Union:
        ...
        # Based on Python's current specs (see https://docs.python.org/3.14/reference/datamodel.html#class-getitem-versus-getitem)
        # regarding what the return type for `__class_getitem__` should be, this should return
        # `types.GenericAlias`, but it doesn't.
        @classmethod
        def __class_getitem__(cls, item: Any, /) -> UnionType | Any: ...
        ...
        def __getitem__(self, parameters: Any, /) -> object: ...
        # In CPython's implemenation of the union object, `__mro_entries__` always raises an error.
